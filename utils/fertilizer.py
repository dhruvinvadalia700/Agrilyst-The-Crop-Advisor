fertilizer_dic = {
	...
	<br/>6. <i> Use nitrogen consuming bacteria </i> - Bacteria such as cyanobacteria (or blue-green algae) Anabaena and Nostoc thrive on nitrogen.""",
        ...
        <br/>2. <i>Plant crops that transfer nitrogen from air to soil </i> – tomatoes, corn, broccoli, cabbage and spinach are examples of plants that thrive off nitrogen and will suck the nitrogen dry.
	...
	<br/>6. <i> Use nitrogen suppling bacteria </i> - Bacteria such as Azotobacter, Bacillus, Clostridium, and Klebsiella transfer nitrogen from air to soil""",
        ...
        <br/><br/>1. <i>Avoid adding more fertilizer</i> – To correct problems caused by excessive soil phosphorus, begin by avoiding future phosphorus applications. Limiting the addition of manure will help reduce phosphorus being added.
        ...
        <br/>3. <i>Watering your soil</i> – soaking your soil liberally will aid in driving phosphorous out of the soil. This is recommended as a last ditch effort.
	...
	<br/>6. Affected plants need additional iron and zinc. However, simply adding iron and zinc to the soil will not work. Research shows that soil-applied iron is rapidly tied up by alkaline soils and its availability to plants is limited.
	<br/>7. Organic nitrogen sources or mulches are needed, use very low phosphorus products such as blood meal (as a nitrogen source) or pine bark mulch""",
	...
	""",
        ...
        <br/>2.<i> Wood ash </i> -can also be used, but make sure that you apply wood ash only lightly, as too much can burn your plants.

        <br/>3.<i> Greensand </i> -which is available from most nurseries, will also add potassium to you garden.
        ...
        <br/>6. Adequate moisture is necessary for effective potassium uptake; low soil water reduces K uptake by plant roots.

	<br/>7. Liming acidic soils can increase potassium retention in some soils by reducing leaching; practices that increase soil organic matter can also increase potassium retention.        
	
	<br/>8. Can try growing wheat,soyabean and peanuts.
""",
    }